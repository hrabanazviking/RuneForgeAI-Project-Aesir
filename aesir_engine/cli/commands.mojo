...
def print_general_help():
    ...
    print("      [--model-store path | --config file] [--tui] [--prompts file] [--log file] [--max-tokens N] [--context N] [--system text]")
    print("      Omit model to choose an installed catalog model interactively.")
    print("      --show-settings with an explicit model previews native config/recipe/CLI settings as JSON; no GPU load.")
    ...
    print("      [--autosave-dir existing-private-directory] [--autosave-retain 1..64]")
    print("      Optional crash recovery; restores the latest compatible committed generation.")
    ...
    print("      --system text overrides the stored recipe; --show-settings previews without a listener or key.")
    print("      [--model-store path | --config file]; -c aliases --config; no implicit config loading.")
