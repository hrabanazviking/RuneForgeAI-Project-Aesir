...
| Automated checks | The counted suite reports 160 passed, 0 failed, and 1 explicit external-fixture skip (161 total). Physical CUDA/model checks remain opt-in; hosted CI does not claim GPU execution. |
