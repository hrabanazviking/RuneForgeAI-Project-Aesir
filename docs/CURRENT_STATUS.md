...
- GPTQ 4-bit now has a checked AutoGPTQ-compatible host dequantization/GEMM
  ...
  CUDA dispatch, and full-model GPTQ execution remain unfinished. GPTQ 8-bit,
  AWQ, EXL2, HQQ, SmoothQuant, IQ/extreme quantization, OpenAI, Ollama,
