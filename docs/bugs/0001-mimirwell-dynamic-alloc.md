...
## Fix Applied
I replaced the dynamic allocation and leak with returning `self.base_ptr` on exhaustion, preserving pointer non-nullability constraints while aborting allocation safely.
