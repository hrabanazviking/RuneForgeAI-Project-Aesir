...
- **Files**: [test.mojo](../../../aesir_engine/test.mojo), [test2.mojo](../../../aesir_engine/test2.mojo), [test3.mojo](../../../aesir_engine/test3.mojo), [test4.mojo](../../../aesir_engine/test4.mojo), [test_buf.mojo](../../../aesir_engine/test_buf.mojo), [test_callback.mojo](../../../aesir_engine/test_callback.mojo), [test_dict.mojo](../../../aesir_engine/test_dict.mojo), [test_engine.mojo](../../../aesir_engine/test_engine.mojo), [test_keepalive.mojo](../../../aesir_engine/test_keepalive.mojo), [test_mojo.mojo](../../../aesir_engine/test_mojo.mojo), [test_parse.mojo](../../../aesir_engine/test_parse.mojo), [test_sys.mojo](../../../aesir_engine/test_sys.mojo), [test_trait.mojo](../../../aesir_engine/test_trait.mojo)
...
- **File**: [replace_gguf.mojo](../../../aesir_engine/replace_gguf.mojo) (147 lines)
...
- **File**: [test_server_loop.mojo](../../../aesir_engine/test_server_loop.mojo) (71 lines)
...
- **File**: [aesir.mojo](../../../aesir_engine/aesir.mojo) line 302
...
- **File**: [CAPABILITY_LEDGER.md](../../../CAPABILITY_LEDGER.md) line 40
...
- **File**: [server/api.mojo](../../../aesir_engine/server/api.mojo) line 48-49
...
- **File**: [server/api.mojo](../../../aesir_engine/server/api.mojo) lines 353-361
...
- **File**: [core/compute.mojo](../../../aesir_engine/core/compute.mojo) line 454
...
| File | Lines | Verdict |
|------|-------|---------|
| [mimir_well.mojo](../../../aesir_engine/core/mimir_well.mojo) | 787 | **CLEAN** — Real bump allocator, KVCache ring buffer, MimirStore vector store, shard split functions. All verified code. |
| [compute.mojo](../../../aesir_engine/core/compute.mojo) | 887 | **CLEAN** (L-4 noted) — Real SIMD kernels. GEMM, Flash Attention-2, GQA, RMSNorm, RoPE, SiLU, GeGLU, cosine similarity, 10 dequantization formats. Unimplemented GPU/NPU paths honestly raise. |
| [inference.mojo](../../../aesir_engine/core/inference.mojo) | 549 | **CLEAN** — Real transformer forward pass with single-device and multi-device sharded paths. Layer-by-layer with residuals, RoPE, KV cache append, GQA attention, SwiGLU FFN. |
| [sampler.mojo](../../../aesir_engine/core/sampler.mojo) | 305 | **CLEAN** — Real xorshift64 RNG, full sampling stack: temperature, top-k, top-p, min-p, repetition/frequency/presence penalties, token suppression masks. |
| [session.mojo](../../../aesir_engine/core/session.mojo) | 142 | **CLEAN** — Real session lifecycle with UUID generation, token counting, cancellation. |
| [swarm.mojo](../../../aesir_engine/core/swarm.mojo) | 259 | **CLEAN** — Honest scaffold. SwarmCluster correctly raises "not implemented" for network operations. Local data structures are real. |
| [error_guard.mojo](../../../aesir_engine/core/error_guard.mojo) | 52 | **CLEAN** — Real NaN/Inf logit sanitizer and null pointer guard. |
| [event_bus.mojo](../../../aesir_engine/core/event_bus.mojo) | 61 | **CLEAN** — Scaffold: records last event string. Honestly labeled `scaffold` in ledger. |
| [grammar.mojo](../../../aesir_engine/core/grammar.mojo) | 43 | **CLEAN** — Scaffold: GBNF mask structure. Honestly labeled. |
| [speculative.mojo](../../../aesir_engine/core/speculative.mojo) | 45 | **CLEAN** — Scaffold: acceptance arithmetic. Honestly labeled. |
| [state_vault.mojo](../../../aesir_engine/core/state_vault.mojo) | 48 | **CLEAN** — Scaffold: in-memory state marker. Honestly labeled. |
| [supervisor.mojo](../../../aesir_engine/core/supervisor.mojo) | 58 | **CLEAN** — Simulated: heartbeat marker. Honestly labeled `simulated` in ledger. |
| [thread_pool.mojo](../../../aesir_engine/core/thread_pool.mojo) | 29 | **CLEAN** — Scaffold: thread count holder. Honestly labeled. |

### Server & CLI (`server/`, `cli/`)
| File | Lines | Verdict |
|------|-------|---------|
| [server/api.mojo](../../../aesir_engine/server/api.mojo) | 495 | **CLEAN** (L-2, L-3 noted) — Real POSIX socket server, HTTP parser, response framing, write-all loop. Double-free guard present. |
| [server/openai.mojo](../../../aesir_engine/server/openai.mojo) | 55 | **CLEAN** — Scaffold: JSON format builder. Honestly returns scaffold data. |
| [cli/commands.mojo](../../../aesir_engine/cli/commands.mojo) | 263 | **CLEAN** — Real CLI dispatchers with truthful capability boundaries. |
| [cli/manifest.mojo](../../../aesir_engine/cli/manifest.mojo) | 298 | **CLEAN** — Real model manifest with SHA-256 digest, disk serialization. |
| [cli/modelfile.mojo](../../../aesir_engine/cli/modelfile.mojo) | 253 | **CLEAN** — Real Modelfile parser with quoting, directive extraction, GenerationConfig conversion. |
| [cli/options.mojo](../../../aesir_engine/cli/options.mojo) | 89 | **CLEAN** — Real flag parser with fail-closed error handling, hardened duration parser. |
| [cli/repl.mojo](../../../aesir_engine/cli/repl.mojo) | 125 | **CLEAN** — Real REPL session with slash commands, parameter setting, context management. |
| [aesir.mojo](../../../aesir_engine/aesir.mojo) | 513 | **CLEAN** (M-4 noted) — Real orchestrator with generation loop, RAG context, streaming, chat template, session binding. |

### Loader & Tokenizer (`loader/`)
| File | Lines | Verdict |
|------|-------|---------|
| [loader/gguf.mojo](../../../aesir_engine/loader/gguf.mojo) | 681 | **CLEAN** — Real GGUF parser with mmap, binary header parsing, KV pair extraction, tensor table, F32→F16 norm conversion, vocabulary loading. |
| [loader/tokenizer.mojo](../../../aesir_engine/loader/tokenizer.mojo) | 332 | **CLEAN** — Real BPE tokenizer with byte fallback, iterative pair merging, UTF-8 stream decoder with multi-byte chunk boundary handling. |
| [loader/chat_template.mojo](../../../aesir_engine/loader/chat_template.mojo) | 142 | **CLEAN** — Real ChatML/Llama2/Mistral/Alpaca/Zephyr template formatter. |
| [loader/huggingface.mojo](../../../aesir_engine/loader/huggingface.mojo) | 73 | **CLEAN** — String helpers with honest "download unsupported" boundary. |
| [loader/onnx.mojo](../../../aesir_engine/loader/onnx.mojo) | 31 | **CLEAN** — Honest "unavailable" scaffold. |
