...
13. **Universal Compressed LLM Format Matrix:**
   ...
   - **External quantization boundary:** GPTQ, AWQ, EXL2, HQQ, and SmoothQuant are reserved descriptors with explicit mutation-free rejection; their format-specific metadata and layouts are not implemented.
